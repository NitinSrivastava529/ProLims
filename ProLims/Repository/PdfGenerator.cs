...
namespace ProLims.Repository
{
    public class PdfGenerator
    {
        ...
        public FileResult ConvertToPdf(string htmlHeader, string htmlBody, string htmlFooter, string pdf_fileName)
        {
            ...
            htmlToPdfConverter.SerialNumber = "PXVUbG1Z-W3FUX09c-T0QMCBMN-HQwdDh0M-HQ4MEwwP-EwQEBAQ=";
            ...
            htmlToPdfConverter.Document.PageSize = (PageName == "Canteen") ? GetSelectedPageSizeCanteen() : GetSelectedPageSize(PageName);
        ...
        public FileResult ConvertToUrlPdf(string UrlName, string pdf_fileName)
        {
            ...
            // convert HTML to PDF
            byte[] pdfBuffer = null;
            pdfBuffer = htmlToPdfConverter.ConvertUrlToMemory(UrlName);
            //pdfBuffer = htmlToPdfConverter.ConvertHtmlToMemory(htmlBody, null);
            //pdfBuffer = htmlToPdfConverter.ConvertHtmlToPdfDocument(htmlBody, null);
            FileResult fileResult = new FileContentResult(pdfBuffer, "application/pdf");
            //for downloading use below line and direct view do not write below line
        ...
        private PdfPageSize GetSelectedPageSizeCanteen()
        {
