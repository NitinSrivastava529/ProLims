...
function DiagnosticBookingReportByVisitNo(VisitNo) {
    //ShowHideLoader("Show");
    var url = config.baseUrl + "/api/Patient/DiagnosticBookingReportByVisitNo";
    var objBO = {};
...
function DownloadReport(visitNo, TestIds,Isheader) {
    $('#LineLoader').attr("src", '#');
    ...
    var url = config.baseUrl + "/api/Patient/DownloadLISReport";
    var objBO = {};
    objBO.VisitNo = visitNo;
