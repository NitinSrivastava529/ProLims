...
$(document).ready(function () {
    ...
    GetAuditNoAndItemList();

});
function GetAuditNoAndItemList() {
    $("#txtAuditNo").val("");
            ...
            if (data.ResultSet.Table.length > 0) {
                ...
                if (data.ResultSet.Table1.length > 0) {
                    ...
                    $.each(data.ResultSet.Table1, function (key, val) {
                        htmldata += '<tr>';
                        htmldata += '<td style="width:1%"><a id="btnItemStock' + key + '" href="javascript:void(0)" selectRow($(this)) onclick="SelectItem(' + "'" + val.item_id + "'" + ',' + "'" + val.item_name + "'" + ')"><i class="fa fa-arrow-circle-right" style="color:red;font-size:15px;"></i></a></td>';
        ...
        success: function (data) {
            if (data.ResultSet.Table.length > 0) {
                ...
                $.each(data.ResultSet.Table, function (key, val) {
                    ...
                    htmldata += '<td style="display:none">' + val.ItemId + '</td>';
                    htmldata += '<td style="display:none">' + val.masterKeyId + '</td>';
...
function InsertAuditInfo() {
    ...
    var url = config.baseUrl + "/api/Audit/InsertAuditInfo";
