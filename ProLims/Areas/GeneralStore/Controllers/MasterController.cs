...
namespace ProLims.Areas.GeneralStore.Controllers
{
    public class MasterController : Controller
    {
        ...
        public ActionResult PackMaster()
        {
            return View();
        }
        ...
        public ActionResult GroupTracking()
        {
            return View();
        }
        ...
        public ActionResult BestRateMaster()
        {
            return View();
        }

        public ActionResult HIS_LISDoctorLink()
        {
            return View();
        }
        public ActionResult TestPerformReport()
        {
            return View();
        }
