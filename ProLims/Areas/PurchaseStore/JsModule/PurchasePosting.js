            ...
            if (data != '') {
                ...
                $.each(data.ResultSet.Table, function (key, val) {
                    if (vendor != val.vendor_name) {
                        str += '<tr style="background:#e3e3e3">';
                        str += '<td colspan="4"> ' + val.vendor_name + '</td>';
                        str += '</tr>';
                    ...
                    str += '<td><button class="btn btn-success getUnCompPurchase" style="height:25px" data-pId=' + val.Purch_id + '><i class="fa fa-check"></i></button></td>';
                    str += '</tr>';
                });
        ...
        success: function (data) {
            if (data != '') {
                ...
                $.each(data.ResultSet.Table1, function (key, val) {
                    ...
                    $('span[data-billamount]').text(ba).toFixed(2);
                });
...
function PurchasePosting() {
    ...
    if (pid != '' && $('#ddlPayMode').val() != 'Select') {
        ...
        alert('Please Choose Any Purchase... or Pay Mode');
    }
}